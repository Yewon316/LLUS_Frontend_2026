    ...
    <div className="section">
      <div>
        ...
        <div className="filter_buttons">
          <button className={`filter_text ${activeFilter==="All"?"filter_text--active":""}`} onClick={()=>setActiveFilter("All")}>All</button>
          <button className={`filter_text ${activeFilter==="Creative"?"filter_text--active":""}`} onClick={()=>setActiveFilter("Creative")}>Creative</button>
          <button className={`filter_text ${activeFilter==="Outdoor"?"filter_text--active":""}`} onClick={()=>setActiveFilter("Outdoor")}>Outdoor</button>
          <button className={`filter_text ${activeFilter==="Social"?"filter_text--active":""}`} onClick={()=>setActiveFilter("Social")}>Social</button>
        </div>
